#--------- Flask settings
SERVER_HOST = 'proj2-webapp-tlt.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://project2-funcapp-tlt.azurewebsites.net/api"
